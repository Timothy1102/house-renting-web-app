...
houseRouter.post('/api/v1/house', [verifyJwtToken, upload], houseController.createHouse); //create a new house
...
houseRouter.post('/api/v1/house/room', [verifyJwtToken, upload], houseController.createRoom); //create a new room
