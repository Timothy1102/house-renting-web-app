...
authRouter.post(`${basePath}/register`, validateCredentials, authController.register);
authRouter.post(`${basePath}/login`, validateCredentials, authController.login);
authRouter.get(`${basePath}/is-authorized`, verifyJwtToken, authController.userAuthorized);
